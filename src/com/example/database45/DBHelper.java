...
public class DBHelper extends SQLiteOpenHelper {
	...
	public DBHelper(Context context, String dbName) {
		...
		dbname = dbName;
		if (!context.getDatabasePath(dbname).exists()) copyBDfromAssets(context);
	}
		
	public void copyBDfromAssets(Context context) {
		...
		try {
			...
			out = new BufferedOutputStream(new FileOutputStream(context.getDatabasePath(dbname)), 8192);
